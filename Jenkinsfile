        ...
        stage('Build & Deploy: Auth Service') {
            ...
            steps {
                script {
                    ...
                    MANIFEST_FILE = "${K8S_MANIFEST_DIR}/auth-service.yaml"
                ...
                withVault(
                    configuration: [
                        vaultUrl: "${VAULT_ADDR}",
                        vaultCredentialId: "${VAULT_SECRET_ID_CREDS}",
                        engineVersion: 2
                    ],
                    vaultSecrets: [[
        ...
        stage('Build & Deploy: Patient Service') {
            ...
            steps {
                script {
                    ...
                    MANIFEST_FILE = "${K8S_MANIFEST_DIR}/patient-service.yaml"
                    MANIFEST_ABS_PATH = "${pwd()}/${MANIFEST_FILE}"
                }
        ...
        stage('Build & Deploy: Frontend') {
            ...
            steps {
                script {
                    ...
                    DIR_NAME = "frontend"
                    MANIFEST_FILE = "${K8S_MANIFEST_DIR}/frontend.yaml"
                    MANIFEST_ABS_PATH = "${pwd()}/${MANIFEST_FILE}"
                }
